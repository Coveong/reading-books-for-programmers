...
현실세계와 다르게 사람의 손길이 없어도 상관는 것들이 있다. (ex. 알아서 불키는 전등, 스스로 금액 인출하는 통장)
...
식별 가능한 개체 또는 사물, 구체적인 사물일 수, 추상적일 수도 있다.
...
때로는 단순한 값이 아니라 객체를 사용해 다른 객체의 사용할 때도 있다.
...
외부의 요청 또는 수시된 메시지에 응답하기 위해 동작하고 반응하는 활동
